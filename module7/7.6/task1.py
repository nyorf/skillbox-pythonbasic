...
# на которой еле-еле видны числа 114 12 14 10605 4907 450. Ирина предположила что это такой шифр и хочет использовать
# программу, которую использовали для расшифровки целой книги из таких чисел.
